    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6 flex flex-wrap gap-3">
          <Button
            onClick={() => router.push('/landlord/payment-calendar')}
          ...
          <Button
            onClick={() => router.push('/landlord/maintenance')}
            variant="secondary"
            className="w-full sm:w-auto flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button
            onClick={() => router.push('/landlord/communication')}
            variant="secondary"
            className="w-full sm:w-auto flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button
            onClick={() => router.push('/landlord/statements')}
            variant="secondary"
            className="w-full sm:w-auto flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button
            onClick={() => router.push('/landlord/reports')}
            variant="secondary"
            className="w-full sm:w-auto flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="divide-y">
              {tenancies.map((tenancy) => (
                <div
                  ...
                  onClick={() => router.push(`/landlord/${tenancy.id}`)}
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div>
                      <Button
                        onClick={(e) => {
                          e.stopPropagation();
                          router.push(`/landlord/${tenancy.id}`);
                        }}
            ...
            <div className="divide-y">
              {recentMaintenance.map((request) => (
                <div
                  ...
                  onClick={() => router.push(`/landlord/maintenance/${request.id}`)}
                >
            ...
            <div className="p-4 space-y-3">
              {recentCommunications.map((comm) => (
                <CommunicationListItem
                  key={comm.id}
                  tenancy={comm}
                  href={`/landlord/communication/${comm.id}`}
                  variant="compact"
                />
              ))}
            </div>
